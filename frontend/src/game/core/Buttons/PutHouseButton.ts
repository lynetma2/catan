...
import {HouseSVGString} from "@/assets/assets.tsx";
...
export class PutHouseButton implements Button {
    type: ButtonType;
    ...
    onClick(event: { x: number; y: number }): void {
        ...
        this.eventBus.publish('PressedButtonEvent', EventBus.createEvent({buttonType: ButtonType.putHouse}))
    }
    ...
    draw() {
        ...
        image.src = HouseSVGString(this.iconWidth, this.iconHeight, this.color);
