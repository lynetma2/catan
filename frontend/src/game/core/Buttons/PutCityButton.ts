...
import {CitySVGString} from "@/assets/assets.tsx";
import type {InteractionManager} from "@/game/input/InteractionManager.ts";

export class PutCityButton implements Button {
    type: ButtonType;
    ...
    draw() {
        ...
        image.src = CitySVGString(this.iconWidth, this.iconHeight, this.color);
